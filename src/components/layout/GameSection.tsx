...
export const GameSection = (props: GameSectionProps) => {
  ...
  let { numberSelected,
        ...
        fastMode,
        cellSelected,
        initArray } = useNanpureContext();

  /*Método 1: realce de célula.    */
  ...
  /*
   Método 2 : Destaque todas as células com
   o mesmo número da célula atual.
   */
  ...
  /**
   * Retorna as classes de uma célula relacionada à célula selecionada.
   */
  ...
  /**
   * Retorna as classes ou uma célula não relacionada à célula selecionada.
   */
